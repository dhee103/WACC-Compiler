...
trait ArithmeticBinaryOperationNode extends BinaryOperationNode {
  override def getType: TypeNode = {
    ...
    if (bothExprsInts) {
      ...
      SemanticErrorLog.add("Argument of int type expected in arithmetic binary operation.")
      ErrorTypeNode()
    }
  }
}
...
trait OrderComparisonOperationNode extends BinaryOperationNode {
  override def getType: TypeNode = {
    ...
    if (bothExprsInts || bothExprsChars) {
      ...
      SemanticErrorLog.add("Argument of wrong type in arithmetic binary operation.")
      ErrorTypeNode()
    }
  }
}
...
trait ComparisonOperationNode extends BinaryOperationNode {
  override def getType: TypeNode = {
    ...
    if (exprsAreSameType) {
      ...
      SemanticErrorLog.add("Argument of non-matching types in comparison operation.")
      ErrorTypeNode()
    }
  }
}
...
trait BooleanBinaryOperationNode extends BinaryOperationNode {
  override def getType: TypeNode = {
    ...
    if (bothExprsBools) {
      ...
      SemanticErrorLog.add("Argument of boolean type expected in logical binary operation.")
      ErrorTypeNode()
    }
  }
}
